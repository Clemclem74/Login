...
--------------------------------------------------------
--  DDL for Table POLLBB
--------------------------------------------------------
  CREATE TABLE "SYSTEM"."POLLBB" 
   (	"ID_POLLBB" VARCHAR2(20 BYTE), 
	"ID_USER_PUBLISHER" VARCHAR2(20 BYTE), 
	"TITLE_POLLBB" VARCHAR2(50 BYTE), 
	"CHOICES_POLLBB" VARCHAR2(200 BYTE), 
	"ID_BDE" VARCHAR2(20 BYTE), 
...
--  DDL for Table VOTE
--------------------------------------------------------
 CREATE TABLE "SYSTEM"."VOTE" 
   (	"ID_VOTE" NUMBER NOT NULL ENABLE, 
	"ID_VOTER" NUMBER, 
	"CHOICE_VOTE" NUMBER, 
	"ID_POLL" NUMBER NOT NULL ENABLE, 
	"ID_BDE" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MEETING" 
   (	"ID_MEETING" NUMBER, 
	"PUBLISHER_MEETING" NUMBER, 
	"TITLE_MEETING" VARCHAR2(100 BYTE), 
	"DATE_MEETING" VARCHAR2(30 BYTE), 
	"ID_BDE" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PARTICIPE" 
   (	"ID_PARTICIPE" NUMBER, 
	"ID_MEETING" NUMBER, 
	"CHOICE_PARTICIPE" VARCHAR2(50 BYTE), 
	"ID_BDE" NUMBER, 
	"ID_PARTICIPER" NUMBER
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
